...
" Palette
let background = "#03110F"
let green      = "#03111F"
let foreground = "#d3ddd9"
let cursor     = "#d3ddd9"
let white      = "#ffffff"
...
hi StatusLineTermNC ctermbg=NONE ctermfg=0 cterm=BOLD
hi  StatusLineTerm ctermbg=NONE ctermfg=white cterm=BOLD

hi StatusLine ctermbg=NONE ctermfg=0
hi StatusLineNC ctermbg=NONE ctermfg=0 cterm=BOLD

hi TabLine ctermbg=NONE ctermfg=8 cterm=BOLD
hi TabLineFill ctermbg=NONE ctermfg=0
hi TabLineSel ctermbg=13 ctermfg=green cterm=BOLD
...
hi CurSearc ctermbg=15 ctermfg=0
...
hi WarningMsg ctermbg=NONE ctermfg=15 cterm=bold
hi ErrorMsg ctermbg=NONE ctermfg=8 cterm=bold
...
hi CursorLine ctermbg=2 ctermfg=0 cterm=NONE
hi LineNr ctermbg=NONE ctermfg=3 cterm=NONE
hi CursorLineNr ctermbg=2 ctermfg=15 cterm=BOLD
...
hi Conditional ctermbg=NONE ctermfg=4 cterm=BOLD
hi Statement ctermbg=NONE ctermfg=4 cterm=BOLD
hi Repeat ctermbg=NONE ctermfg=4 cterm=BOLD
hi Constant ctermbg=NONE ctermfg=7
hi Character ctermbg=NONE ctermfg=3
hi String ctermbg=NONE ctermfg=3 
hi Float ctermbg=NONE ctermfg=7

hi Delimiter ctermbg=NONE ctermfg=5
hi Include ctermbg=NONE ctermfg=4 cterm=BOLD
hi PreProc ctermbg=NONE ctermfg=4 cterm=BOLD
hi Define ctermbg=NONE ctermfg=7
hi Keyword ctermbg=NONE ctermfg=3
