...
hi Conditional guifg=#3e8fb0 guibg=NONE gui=NONE cterm=bold
...
hi Keyword guifg=#3e8fb0 guibg=NONE gui=NONE cterm=bold
...
hi Repeat guifg=#3e8fb0 guibg=NONE gui=NONE cterm=bold
...
hi Statement guifg=#3e8fb0 guibg=NONE gui=NONE cterm=bold
hi StorageClass guifg=#9ccfd8 guibg=NONE gui=NONE cterm=NONE
hi String guifg=#f6c177 guibg=NONE gui=NONE cterm=NONE
hi Structure guifg=#9ccfd8 guibg=NONE gui=NONE cterm=bold
hi Tag guifg=#ea9a97 guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#c4a7e7 guibg=NONE gui=NONE cterm=bold
hi Type guifg=#9ccfd8 guibg=NONE gui=NONE cterm=NONE
hi Typedef guifg=#9ccfd8 guibg=NONE gui=NONE cterm=bold
...
if s:t_Co >= 256
  ...
  hi Keyword ctermfg=31 ctermbg=NONE cterm=bold
  ...
  hi Structure ctermfg=152 ctermbg=NONE cterm=bold
  ...
  hi Typedef ctermfg=152 ctermbg=NONE cterm=bold
